...
def test_open_login_page(setup_playwright) -> None:
    ...
    user_email = register_page.generate_timestamp_email()
    register_page.perform_registration(user_email,"Testx", "Testy")
    take_screenshot(main_page, "login_page_screen_shot")
    login_page.perform_login(user_email, "Viva#100")
