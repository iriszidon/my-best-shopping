...
class MainPage(BasePage):
    ...
    def search_items_by_name_under_price(self, query: str, max_price: int, limit =5) -> List[str]:
        # search by a query
    ...
    def assert_cart_total_not_exceeds(self, budget_per_item: int, items_count: int) -> None:
        # open that cart
